/**
 * Audit rozšiřující banky úloh rpg-tasks-6.js
 * Spusť: node tests/rpg-tasks-6.audit.cjs
...
new Function(code)();   // naplní window.RPG_TASK_EXTRA_6
const EX = global.window.RPG_TASK_EXTRA_6;

const MC = new Set(['1-1','2-1','3-2']);
const ITER = 3000;
...
console.log('\n══════════════════════════════════════════');
console.log('  Audit rpg-tasks-6.js — rozšiřující banka');
console.log('══════════════════════════════════════════');
