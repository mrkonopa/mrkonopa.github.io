/**
 * Audit rozšiřující banky úloh rpg-tasks-8.js
 * Spusť: node tests/rpg-tasks-8.audit.cjs
...
global.svgCyl = ()=>'<svg></svg>';
global.svgCircleR = ()=>'<svg></svg>';
global.window = {};
...
const MC = new Set(['1-1','2-1','3-1','4-1','5-1','6-1','7-3']);
const ITER = 3000;
...
console.log('\n══════════════════════════════════════════');
console.log('  Audit rpg-tasks-8.js — rozšiřující banka');
console.log('══════════════════════════════════════════');
