...
window.RPGSprites5 = (function () {
  ...
  const PAL_HERO = {
    K:'#0a0c12', J:'#b02a2a', j:'#6a1414', C:'#f5c896', c:'#c08050',
    G:'#e0b020', B:'#23232e', W:'#f0e0c0', Y:'#ffd84a'
  };
  const HERO_SKINS = {
  ...
  const PAL_COM = { K:'#0a0c12', S:'#c84028', s:'#7e2614', C:'#ffaa60', c:'#c87030', Y:'#ffd040', k:'#aa8800' };
  const COMPANION = [[
    '......KYK.....',
    '....KKYYYKK...',
    '...KSSSSSSSK..',
