...
(function () {
  ...
  function gen_4_3() {
    ...
    const T = [
      ...
      () => { const cena = ri(3, 9), penize = cena * ri(3, 9); return { text: `Jedna kouzelná fazole stojí ${cena} ${skl(cena, 'zlaťák', 'zlaťáky', 'zlaťáků')}. Kolik fazolí koupíš za ${penize} zlaťáků?`, ans: penize / cena, h1: `${penize} : ${cena}`, h2: `= ${penize / cena}` }; },
      // — se zbytkem —
