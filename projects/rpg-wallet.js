...
window.RPGWallet = (function () {
  ...
  const SHOP_ITEMS = [
    ...
    { id: 'skin-gold',    cat: 'skin', name: 'Zlatý rytíř',    ic: '🥇', price: 2800, skinKey: 'skin-gold' },
    { id: 'skin-red',     cat: 'skin', name: 'Rudý bojovník',   ic: '🔴', price:  600, skinKey: 'skin-red' },
    { id: 'skin-emerald', cat: 'skin', name: 'Smaragdový lovec',ic: '💚', price:  750, skinKey: 'skin-emerald' },
    { id: 'skin-ghost',   cat: 'skin', name: 'Duch neoneonu',   ic: '👻', price: 1900, skinKey: 'skin-ghost' },
    { id: 'skin-stealth', cat: 'skin', name: 'Stínový agent',   ic: '🥷', price:  1200, skinKey: 'skin-stealth' },
    ...
    { id: 'border-dragon', cat: 'border', name: 'Dračí šupiny',    ic: '🐉', price: 1600, cssKey: 'av-dragon' },
    ...
    { id: 'badge-rainbow', cat: 'badge',  name: 'Duhový přeliv',   ic: '🌈', price: 1500, cssKey: 'nm-rainbow' },
    { id: 'theme-space',   cat: 'theme',  name: 'Hlubina vesmíru', ic: '🌌', price: 1300, cssKey: 'space' },
    { id: 'theme-temple',  cat: 'theme',  name: 'Chrámové zlato',  ic: '🏛️', price: 1500, cssKey: 'temple' },
    ...
    { id: 'pu-novice-shield', cat: 'powerup', name: 'Štít nováčka',   ic: '⛨',  price: 1400, minLevel: 3, desc: 'První špatná odpověď v každém boji tě nezraní.' },
    { id: 'pu-study-guide',   cat: 'powerup', name: 'Studijní rádce', ic: '🔁', price: 1200, minLevel: 5, desc: 'V tréninku ti jedna chyba za sezení nezlomí sérii.' },
    { id: 'pu-calm-mind',     cat: 'powerup', name: 'Klidná mysl',    ic: '🧘', price: 2000, minLevel: 8, desc: '+20 % času na každý příklad v normálním boji.' },
    /* ── Dávka 3 — tituly (text pod jménem) ── */
    { id: 'title-pocitar', cat: 'title', name: 'Počtář',         ic: '🧮', price:  300 },
    { id: 'title-lovec',   cat: 'title', name: 'Lovec příkladů', ic: '🎯', price:  600 },
    { id: 'title-strateg', cat: 'title', name: 'Stratég',        ic: '♟️', price:  1000 },
    { id: 'title-mudrc',   cat: 'title', name: 'Mudrc',          ic: '🦉', price:  1700 },
    { id: 'title-genius',  cat: 'title', name: 'Génius',         ic: '🧠', price: 2600 },
    /* ── Dávka 3 — mazlíčci (parťák v profilu) ── */
    { id: 'pet-sova',       cat: 'pet', name: 'Sova',      ic: '🦉', price:  800 },
    { id: 'pet-kocka',      cat: 'pet', name: 'Kočka',     ic: '🐈‍⬛', price:  1200 },
    { id: 'pet-robot',      cat: 'pet', name: 'Robot',     ic: '🤖', price: 1700 },
    { id: 'pet-drak',       cat: 'pet', name: 'Dráček',    ic: '🐉', price: 2200 },
    { id: 'pet-jednorozec', cat: 'pet', name: 'Jednorožec',ic: '🦄', price: 3000 },
    /* ── Dávka 3 — sezónní (v obchodě jen v daném období; koupené zůstává navždy) ── */
    { id: 'border-dyne',  cat: 'border', name: 'Dýňový rám',     ic: '🎃', price: 1600, cssKey: 'av-pumpkin', season: { fm: 10, fd: 15, tm: 11, td: 5 } },
    { id: 'theme-vanoce', cat: 'theme',  name: 'Vánoční',        ic: '🎄', price: 1800, cssKey: 'vanoce',     season: { fm: 12, fd: 1,  tm: 1,  td: 6 } },
    { id: 'border-srdce', cat: 'border', name: 'Srdcový rám',    ic: '💘', price: 2000, cssKey: 'av-heart',   season: { fm: 2,  fd: 1,  tm: 2,  td: 20 } },
    { id: 'theme-leto',   cat: 'theme',  name: 'Letní vlny',     ic: '🏖️', price: 1800, cssKey: 'leto',       season: { fm: 6,  fd: 1,  tm: 8,  td: 31 } },
  ...
  const GACH = [
    { id: 'gach-tasks-1k',    ic: '📚', nm: 'Znalec',             stat: 'tasks',     goal: 1000,  reward: { credits: 400 },
      desc: 'Vyřeš 1 000 příkladů (počítá se napříč všemi ročníky).' },
    { id: 'gach-tasks-10k',   ic: '🕰️', nm: 'Pán času',           stat: 'tasks',     goal: 10000, reward: { credits: 1200, grant: ['title-pan-casu'], perk: 'notimer' },
      desc: 'Vyřeš 10 000 příkladů. Odměna: čas se ti v bojích už NIKDY neodpočítává (kromě Věže legend).' },
    { id: 'gach-crit-1k',     ic: '⚡', nm: 'Bouřlivák',           stat: 'crits',     goal: 1000,  reward: { credits: 600, perk: 'critcredit' },
    ...
    { id: 'gach-master-21',   ic: '🏆', nm: 'Velmistr',            stat: 'mastered',  goal: 21,    reward: { credits: 800 },
      desc: 'Získej 21 mistrovství témat (celý jeden ročník).' },
    { id: 'gach-master-147',  ic: '👑', nm: 'Absolutní velmistr',  stat: 'mastered',  goal: 42,   reward: { credits: 1500, grant: ['title-velmistr', 'pet-zlaty-drak'] },
      desc: 'Získej všech 147 mistrovství (7 ročníků × 21 témat).' },
    { id: 'gach-tower-50',    ic: '🗼', nm: 'Legenda věže',        stat: 'towerFloor',goal: 50,    reward: { credits: 1200, grant: ['title-legenda-veze'] },
      desc: 'Vylez na 50. patro Věže legend.' },
    { id: 'gach-streak-100',  ic: '🔥', nm: 'Věčný plamen',        stat: 'streakMax', goal: 100,   reward: { credits: 1200, grant: ['pet-fenix'] },
      desc: 'Hraj 100 dní v řadě. Odměna: exkluzivní Fénix.' },
    { id: 'gach-earned-50k',  ic: '🤑', nm: 'Magnát',              stat: 'earned',    goal: 12000, reward: { grant: ['title-magnat'] },
