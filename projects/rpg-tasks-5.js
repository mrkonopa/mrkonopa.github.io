...
(function () {
  ...
  function gen_7_3() {
    ...
    const T = [
      ...
      () => { const a=ri(4,16);let b=ri(3,14);if(b===a)b=b<14?b+1:b-1; /* strany různé — jinak z „obdélníku" vyjde čtverec */  return { text: `Obsah obdélníku ${a} cm × ${b} cm? (cm²)`, ans: a * b, h1: `S = a × b.`, h2: `= ${a * b} cm²`, sk: 'geo' }; },
