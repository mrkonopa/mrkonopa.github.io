...
(function () {
  ...
  function gen_5_3() {
    ...
    const T = [
      ...
      () => { const cena = r1(ri(15, 95) / 10); return { text: `Jeden metr lana stojí ${cz(cena)} ${Number.isInteger(cena) ? skl(cena, 'dukát', 'dukáty', 'dukátů') : 'dukátu'}. Kolik stojí 10 metrů?`, ans: r1(cena * 10), h1: `${cz(cena)} × 10`, h2: `= ${cz(r1(cena * 10))}` }; },
